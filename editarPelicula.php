...
<body>
    ...
    <br>
    <h1 class="text-while text-white fs-1 fw-bold text-center">ACTUALIZAR PELICULA</h1>
    <br>
    <form class="col-6 m-auto text-white" action="" method="POST">
            ...
            <button type="submit" class="btn btn-outline-light mx-auto d-block">Actualizar</button>
            <br>
            <br>
    </form>
    </div>
